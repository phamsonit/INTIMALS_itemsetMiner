...
import be.intimals.seqMiner.config.*;
import java.io.*;
...
public class Main {
    ...
    static public void main(String[] args) throws IOException {
        ...
        String configPathBasic = "/Users/user/Working/INTIMALS/softs-gitlab/freqt/seqMiner/conf/java/config.properties";
        Config configBasic = new Config(configPathBasic);

        SeqMiner seq = new SeqMiner(configBasic);
        seq.run();
